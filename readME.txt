FUNCTIONS :- There are nearly 30 function or more functions which this virtual assistent and perform.
...
then,
The Jarvis starts though its GUI and introduce itself, after that it will be hearing you but will not response till you give the command of "WAKE UP" in order to start the conversation with it.
...
if you want to activie it you have to give "WAKE UP" command
then it will start responsing you
and 
if you want to make him go back to SLEEP MODE
say "GO TO SLEEP" command
